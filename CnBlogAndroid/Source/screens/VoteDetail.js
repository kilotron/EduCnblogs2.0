...
const ContentHandler = require('../DataHandler/VoteDetail/ContentHandler');
...
export default class VoteDetail extends Component {
    constructor(props) {
        super(props);
        this.state = {
            voteId:	this.props.navigate.state.voteId,
            name: "",
            content: "",
            descriptio: "",
            privacy	: "",
    ...
    componentWillMount = () => {
        ...
        let contenturl = Config.VoteDetail + this.voteId + '/body';
    ...
    _onPressBookmarks = () => {
        this.props.navigation.navigate('BlogBookmarks', {
